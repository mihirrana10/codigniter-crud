...
<table class="table">
  ...
  <tbody>
	...
	foreach($resultset->result() as $result_row)
	{
		?>
    <tr>
      <th scope="row"><?php echo $result_row->id ?></th>
      ...
      <a  data-toggle="modal" data-target="#editModal" onclick="get_edit_data(<?php echo $result_row->id; ?>);" >Edit</a>

    <!-- | <a class=" confirm-delete" data-id="<?php echo $result_row->id; ?>">Delete</a> -->

    <a href="<?php echo base_url('admin/manage_category/delete/'.$result_row->id);?>">Delete</a>
</td>
    </tr>
	<?php
	}	
