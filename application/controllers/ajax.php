...
public function get_category($id)
	{
	    $edit_profile=$this->db->get_where("tbl_category",array("id"=>$id));
	    ...
	    ?>
	        <div class="box box-primary">
	            <form role="form" method="post" action="<?php echo base_url(); ?>admin/manage_category/edit/do_update/<?php echo $row->id ;?>"  enctype="multipart/form-data">
	                <div class="box-body">
